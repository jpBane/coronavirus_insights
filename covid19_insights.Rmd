...
# test <- jsonlite::fromJSON("https://services7.arcgis.com/mOBPykOjAyBO2ZKk/arcgis/rest/services/Coronaf%C3%A4lle_in_den_Bundesl%C3%A4ndern/FeatureServer/0/query?outFields=*&where=1%3D1")
```
...
choroLayer(spdf = nuts0.spdf, df = covid19_eu, dfid = "country_code", var = "new_cases_100k")
```
